...
import { shortOrderId } from '../printing.utils'
...
export const KitchenReceipt = React.forwardRef<HTMLDivElement, KitchenReceiptProps>(
  function KitchenReceipt({ order }, ref) {
    ...
    return (
      <div ref={ref} className="box-border w-[80mm] max-w-[80mm] bg-white p-4 font-mono text-sm leading-tight text-black">
        ...
        <div className="my-2.5 border-[3px] border-black px-2 py-3 text-center">
          <p className="m-0 text-[10px] font-bold uppercase tracking-widest">Table</p>
          <p className="m-0 mt-2 text-[32px] font-extrabold leading-none">{tableDisplay}</p>
        </div>
